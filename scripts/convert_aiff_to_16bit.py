...
def main() -> None:
    ...
    delete_files_input = input("Do you want to delete the temp files after conversion? y/n\n")
    ...
    available_files: List[str] = find_files(os.getcwd(), extensions=[".aif", ".aiff"], recursive=args.recursive)
    ...
    if len(files_to_convert) > 0:
        ...
        for file_name in files_to_convert:
            if convert_aif_to_16bit(file_name) and should_delete_files:
